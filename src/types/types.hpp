	...
	*/
	...
	namespace __impl_merge
	{
		...
		template <
			...
			typename... Ts2,
			typename... Rest>
		struct merge<std::tuple<Ts1...>, std::tuple<Ts2...>, Rest...>
		{
			using type = typename merge<std::tuple<Ts1..., Ts2...>, Rest...>::type;
		};
		template <typename Tuple>
		struct merge<Tuple>
		{
	...
	template <template <typename /* T */,
						std::size_t /* Index */,
						typename /* Tuple */> class /* type */ Predicate,
			  typename Tuple>
	class map
	{
		...
		struct helper<Index, std::tuple<T, Ts...>>
		{
			using type = typename merge<
				std::tuple<typename Predicate<T, Index, Tuple>::type>,
	...
	public:
		using type = std::pair<
			typename transfer<merge, typename splitted::first_type>::type::type,
			typename transfer<merge, typename splitted::second_type>::type::type>;
	};
